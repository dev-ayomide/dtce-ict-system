      ...
      >
        <div className="w-full max-w-7xl mx-auto px-4 md:px-8 lg:px-16 flex flex-col h-full">
          ...
          <div className="w-full flex items-center justify-between pt-4 pb-0">
            <h2 className="text-2xl font-semibold text-gray-400" style={{ fontFamily: "inherit" }}>Profile</h2>
            <button
              onClick={onClose}
          ...
          <div className="w-full flex-1 flex flex-col mt-4">
            <div className="w-full mb-6">
              <div className="flex items-center justify-between mb-4">
                <h4 className="text-lg font-semibold text-black" style={{ fontFamily: "inherit" }}>Personal Information</h4>
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-xs text-gray-500 mb-1" style={{ fontFamily: "inherit" }}>Name</p>
                  <p className="text-sm text-black font-medium" style={{ fontFamily: "inherit" }}>
                    {user?.name || "N/A"}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 mb-1" style={{ fontFamily: "inherit" }}>Email Address</p>
                  <p className="text-sm text-black font-medium" style={{ fontFamily: "inherit" }}>
                    {user?.email || "N/A"}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 mb-1" style={{ fontFamily: "inherit" }}>Province</p>
                  <p className="text-sm text-black font-medium" style={{ fontFamily: "inherit" }}>
                    {user?.province || "N/A"}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 mb-1" style={{ fontFamily: "inherit" }}>Region</p>
                  <p className="text-sm text-black font-medium" style={{ fontFamily: "inherit" }}>
                    {user?.region || "N/A"}
                  </p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 mb-1" style={{ fontFamily: "inherit" }}>Subunit</p>
                  <p className="text-sm text-black font-medium" style={{ fontFamily: "inherit" }}>
